...
import id.izazdhiya.disasterapp.ui.adapter.DisasterAreaAdapter
...
class SearchFragment : Fragment() {
    ...
    private lateinit var disasterAreaList: ArrayList<id.izazdhiya.disasterapp.data.source.DisasterArea>
    ...
    private fun createDisasterArea() {
        ...
        disasterAreaList = ArrayList<id.izazdhiya.disasterapp.data.source.DisasterArea>().apply {
            addAll(
                listOf(
